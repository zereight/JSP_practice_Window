...
<body>
    ...
    <div class="container" style="height: 550px;">
        ...
        <div class="container-fluid p-5 border-info bg-success mt-5" style="border-radius: 5%; color:white; font-weight: 300; font-size: 1.5em;">

            <span> 이메일 인증이 완료되었습니다. 로그인 해주세요! </span>
